package net.greeta.order.payment.service.dataaccess.outbox.adapter;

import net.greeta.order.domain.valueobject.PaymentStatus;
import net.greeta.order.outbox.OutboxStatus;
import net.greeta.order.payment.service.dataaccess.outbox.exception.OrderOutboxNotFoundException;
import net.greeta.order.payment.service.dataaccess.outbox.mapper.OrderOutboxDataAccessMapper;
import net.greeta.order.payment.service.dataaccess.outbox.repository.OrderOutboxJpaRepository;
import net.greeta.order.payment.service.domain.outbox.model.OrderOutboxMessage;
import net.greeta.order.payment.service.domain.ports.output.repository.OrderOutboxRepository;
