...
import net.greeta.order.payment.service.dataaccess.outbox.entity.OrderOutboxEntity;
...
public class PaymentRequestMessageListenerTest {
    ...
    private PaymentRequest getPaymentRequest(String sagaId) {
        return PaymentRequest.builder()
                ...
                .paymentOrderStatus(net.greeta.order.domain.valueobject.PaymentOrderStatus.PENDING)
