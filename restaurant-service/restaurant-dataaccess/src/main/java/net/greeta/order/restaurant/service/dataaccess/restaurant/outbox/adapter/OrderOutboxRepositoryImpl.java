package net.greeta.order.restaurant.service.dataaccess.restaurant.outbox.adapter;

import net.greeta.order.outbox.OutboxStatus;
import net.greeta.order.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import net.greeta.order.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import net.greeta.order.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import net.greeta.order.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import net.greeta.order.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
