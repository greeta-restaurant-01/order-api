package net.greeta.order.domain.mapper;
...
import net.greeta.order.domain.outbox.model.approval.OrderApprovalEventProduct;
...
public class OrderDataMapper {
    ...
    private List<OrderItem> orderItemsToOrderItemEntities(
            List<net.greeta.order.domain.dto.create.OrderItem> orderItems) {
