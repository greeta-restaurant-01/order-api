package net.greeta.order.messaging.mapper;
...
import net.greeta.order.domain.outbox.model.approval.OrderApprovalEventPayload;
...
public class OrderMessagingDataMapper {
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel
        ...
        return PaymentResponse.builder()
                ...
                .paymentStatus(net.greeta.order.common.domain.valueobject.PaymentStatus.valueOf(
    ...
    approvalResponseAvroModelToApprovalResponse(RestaurantApprovalResponseAvroModel
        ...
        return RestaurantApprovalResponse.builder()
                ...
                .orderApprovalStatus(net.greeta.order.common.domain.valueobject.OrderApprovalStatus.valueOf(
