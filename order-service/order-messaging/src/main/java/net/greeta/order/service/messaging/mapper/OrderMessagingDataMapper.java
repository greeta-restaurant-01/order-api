package net.greeta.order.service.messaging.mapper;

import net.greeta.order.kafka.order.avro.model.*;
...
import net.greeta.order.service.domain.dto.message.RestaurantApprovalResponse;
...
public class OrderMessagingDataMapper {
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel
        ...
        return PaymentResponse.builder()
                ...
                .paymentStatus(net.greeta.order.domain.valueobject.PaymentStatus.valueOf(
    ...
    approvalResponseAvroModelToApprovalResponse(RestaurantApprovalResponseAvroModel
        ...
        return RestaurantApprovalResponse.builder()
                ...
                .orderApprovalStatus(net.greeta.order.domain.valueobject.OrderApprovalStatus.valueOf(
    ...
    orderApprovalEventToRestaurantApprovalRequestAvroModel(String sagaId, OrderApprovalEventPayload
        ...
        return RestaurantApprovalRequestAvroModel.newBuilder()
                ...
                .setProducts(orderApprovalEventPayload.getProducts().stream().map(orderApprovalEventProduct ->
                        net.greeta.order.kafka.order.avro.model.Product.newBuilder()
