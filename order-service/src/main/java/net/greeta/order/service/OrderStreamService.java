...
import net.greeta.order.domain.OrderCountPerStoreDTO;
...
import net.greeta.order.domain.TotalRevenue;
...
import static net.greeta.order.topology.OrdersTopology.GENERAL_ORDERS_COUNT;
import static net.greeta.order.topology.OrdersTopology.GENERAL_ORDERS_REVENUE;
import static net.greeta.order.topology.OrdersTopology.RESTAURANT_ORDERS;
import static net.greeta.order.topology.OrdersTopology.RESTAURANT_ORDERS_COUNT;
import static net.greeta.order.topology.OrdersTopology.RESTAURANT_ORDERS_REVENUE;
import static net.greeta.order.topology.OrdersTopology.printLocalDateTimes;
...
public class OrderStreamService {
    ...
    public OrderStreamService(OrderStoreService orderStoreService) {
