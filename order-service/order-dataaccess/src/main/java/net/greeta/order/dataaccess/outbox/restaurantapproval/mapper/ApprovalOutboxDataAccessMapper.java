package net.greeta.order.dataaccess.outbox.restaurantapproval.mapper;

import net.greeta.order.dataaccess.outbox.restaurantapproval.entity.ApprovalOutboxEntity;
