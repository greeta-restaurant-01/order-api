package net.greeta.order.dataaccess.outbox.restaurantapproval.adapter;

import net.greeta.order.dataaccess.outbox.restaurantapproval.repository.ApprovalOutboxJpaRepository;
import net.greeta.order.dataaccess.outbox.restaurantapproval.exception.ApprovalOutboxNotFoundException;
import net.greeta.order.dataaccess.outbox.restaurantapproval.mapper.ApprovalOutboxDataAccessMapper;
