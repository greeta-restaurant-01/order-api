package net.greeta.order.service.dataaccess.outbox.restaurantapproval.adapter;

import net.greeta.order.service.dataaccess.outbox.restaurantapproval.exception.ApprovalOutboxNotFoundException;
import net.greeta.order.service.dataaccess.outbox.restaurantapproval.mapper.ApprovalOutboxDataAccessMapper;
import net.greeta.order.service.dataaccess.outbox.restaurantapproval.repository.ApprovalOutboxJpaRepository;
import net.greeta.order.service.domain.outbox.model.approval.OrderApprovalOutboxMessage;
import net.greeta.order.service.domain.ports.output.repository.ApprovalOutboxRepository;
