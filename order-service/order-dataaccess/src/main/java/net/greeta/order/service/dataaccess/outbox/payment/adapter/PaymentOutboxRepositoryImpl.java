package net.greeta.order.service.dataaccess.outbox.payment.adapter;

import net.greeta.order.service.dataaccess.outbox.payment.exception.PaymentOutboxNotFoundException;
import net.greeta.order.service.dataaccess.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
import net.greeta.order.service.dataaccess.outbox.payment.repository.PaymentOutboxJpaRepository;
import net.greeta.order.service.domain.outbox.model.payment.OrderPaymentOutboxMessage;
import net.greeta.order.service.domain.ports.output.repository.PaymentOutboxRepository;
